<script setup lang="ts">
    ...
    const{signIn} = useAuth()// importando a funsao de login sidebase
    ...
    /*const submitLogin = async() =>{
        console.log("try to login whith credentials below:", credentials);
        try{
    ...
    const submitLogin = () =>{
        ...
        signIn(credentials, {redirect:false}).then(()=>{
                console.log("successefully logged!")
                navigateTo('/home');
            })
